...
Toon aan dat $(D={1,2,3,6}), D(,+,.,\overline{ })$ een Boole algebra is. Hier wordt dus gevraagd om te kijken of alle wetten gelden. We zetten de $kgv$ en de $ggd$ uit, samen met complement. 
...
#### Distributief
- $x. (y + z) = x.y + x.z?$ of m.a.w. $ggd(x,(y+z)) = kgv(ggd(x,y), ggd(x,z))$
- $x + (y.z) = (x + y) . (x + z)$ m.a.w. $ kggv(x,(y.z)) = ggd(kgv(x,y), (x,z))$ 
...
Als we dus kijken naar $x + \overline{x} = 1$ dan zien we dat dat niet klopt en dat $x. \overline{x}= 8$ ook niet opgaat voor $2$ en $4$. 
